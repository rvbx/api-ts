...
CREATE TABLE IF NOT EXISTS user (
    ...
    user_last_name VARCAHR(40) NOT NULL, 
...
INSERT INTO user (
    ...
    user_email,
    user_password
) SELECT 'Rodolfo', 'Villas Boas','rodolfo.villas.boas@rvbx.com', '123456' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'Rodolfo' )
`;
...
INSERT INTO user (
    ...
    user_email,
    user_password
) SELECT 'Eduardo', 'Villas Boas', 'eduardo.villas.boas@rvbx.com', '123456' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'Eduardo' )
`;
